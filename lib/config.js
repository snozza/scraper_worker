...
config.verbose = bool(process.env.VERBOSE) || false;
config.thrifty = bool(process.env.THRIFTY) || true;
config.view_cache = bool(process.env.VIEW_CACHE) || true;

// Security
config.cookie_secret = process.env.COOKIE_SECRET || 'myCookieSecret';
